...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        var colours_design = readData("colours_design");
        var stand_out = readData("stand_out");
        var elem_need_improvement = readData("elem_need_improvement");
        var design_principles = readData("design_principles");
        var likely_buy_product = readData("likely_buy_product");
        var comments = readData("comments");
        res.render('showResults', {results: [colours_design, stand_out, elem_need_improvement, design_principles, likely_buy_product, comments]});
        console.log([colours_design, stand_out, elem_need_improvement, design_principles, likely_buy_product, comments]);
    });
    ...
    app.post('/niceSurvey', urlencodedParser, function(req, res){
        ...
        for (var key in json){
            ...
            if ((key === "design_principles") && (json[key].length === 2)){
